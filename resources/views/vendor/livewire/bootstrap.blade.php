...
<div>
    @if ($paginator->hasPages())
        <nav class="mr-0">
            <div class="grid grid-collumns-2-auto justify-between-g display-none">
                <ul class="pagination">
                    {{-- Previous Page Link --}}
            ...
            <div class="grid grid-collumns-2-auto justify-between-g align-center">
                <div>
                    <p class="text-brown">
                        {!! __('Showing') !!}
                        <span><b>{{ $paginator->firstItem() }}</b></span>
                        {!! __('to') !!}
                        <span><b>{{ $paginator->lastItem() }}</b></span>
                        {!! __('of') !!}
                        <span><b>{{ $paginator->total() }}</b></span>
                        {!! __('results') !!}
                    </p>
                </div>
                    ...
                    <ul class="pagination">
                        ...
                        @foreach ($elements as $element)
                            ...
                            @if (is_string($element))
                                <li class="page-item disabled" aria-disabled="true"><span class="page-link page-item-dis">{{ $element }}</span>
                                </li>
                            @endif
