                ...
                <form wire:submit="save">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="@error('content') error-block @enderror">
                            <div wire:ignore>
                                <textareawire:model="content" class="form-control" type="text" id="summernote"
                                    placeholder="Content of product..." rows="10"></textarea>
                            </div>
                        </div>
                        @error('content')
                    ...
                    <div class="row p-3 gap-30">
                        <div class="mt-4 col-lg-12 col-xl-4 offset-xl-1 image-create p-3">
                            ...
                            <input wire:model="image"
                                class="form-control image-create-input w-auto c-pointer @error('image') is-invalid @enderror"
                                type="file" id="image">
                            @error('image')
                                <span class="invalid-feedback">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="mt-4 col-lg-12 col-xl-4 p-3 offset-xl-1 image-create ">
                            ...
                            <label class="form-label" for="gallery">Gallery:</label> <br>
                            <input wire:model="gallery" class="form-control w-auto c-pointer image-create-input
